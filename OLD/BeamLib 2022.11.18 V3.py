    ...
    def EvaluateAngleEquation(self, Position):
        ...
        for i in self.LoadCase.Elements:
            if i == self:
                ...
                RHS = RHS - i.CumulativeShearForce*(1/2)*(Position-i.CGx)**2
    ...
    def EvaluateDeflectionEquation(self, Position):
        ...
        for i in self.LoadCase.Elements:
            if i == self:
                ...
                RHS = RHS - i.CumulativeShearForce*(1/6)*(Position-i.CGx)**3
    ...
    def ShearForceFunction(self,xs):
        ...
        for i in self.LoadCase.Elements:
            if i == self:
                ...
                ForcePresent = ForcePresent + i.CumulativeShearForce
    ...
    def BendingMomentFunction(self,xs):
        ...
        for i in self.LoadCase.Elements:
            if i == self:
                ...
                # print(i.CGx)
                MomentPresent = MomentPresent + i.CumulativeShearForce*(xs-i.CGx)
    ...
    def AngleThetaFunction(self,xs):
        ...
        for i in self.LoadCase.Elements:
            if i == self:
                ...
                ThetaPresent = ThetaPresent + i.CumulativeShearForce*(1/2)*(xs-i.CGx)**2
    ...
    def DisplacementFunction(self,xs):
        ...
        for i in self.LoadCase.Elements:
            if i == self:
                ...
                DisplacePresent = DisplacePresent + i.CumulativeShearForce*(1/6)*(xs-i.CGx)**3
